                    ...
                    ?>
                      ...
                      <td>
                        <?php if ($pengunjung['status'] == 'unpaid') : ?>
                          <a href="<?= base_url('user/Qris/') . $pengunjung['id_booking']; ?>" target="_blank" name="filter" class="badge badge-warning text-primary">Cetak&nbsp;<i class="fas fa-print text-danger"></i></a>
                        <?php else : ?>
                          <a href="<?= base_url('user/struk/') . $pengunjung['id_booking']; ?>" target="_blank" name="filter" class="badge badge-info text-primary">Cetak&nbsp;<i class="fas fa-print text-danger"></i></a>
                        <?php endif; ?>
                      </td>
                  </tr>
                <?php endforeach; ?>
