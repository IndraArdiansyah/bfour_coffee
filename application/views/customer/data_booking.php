              ...
              <table class="table table-bordered table-striped tabel-hover align-middle text-center" id="table-datatable">
                ...
                foreach ($temp as $t) { ?>
                  <tr>
                    ...
                    <td>
                      <a href="<?= base_url('user/hapusbooking/' . $t['id_menu']); ?>" onclick="return confirm('Yakin tidak jadi Booking <?= $t['nama_menu']; ?>')" class="btn btn-sm btn-outline-danger"><i class="fas fw fa-trash"></i></a>
                    </td>
                  </tr>
                <?php
                  $no++;
                ...
                <tr>
                  ...
                  <td colspan="3">
                    ...
                    <a href="<?= base_url() . 'user/selesai/' . $this->session->userdata('nip'); ?>" id="selesai" class="selesai btn btn-sm btn-outline-success"><span class="fas fw fa-stop"></span> Selesaikan Booking</a>
                  </td>
                  <td colspan="2">
                    <b>Subtotal :</b>
                  </td>
              ...
              <div class="row">
                ...
                <?php foreach ($addons as $addon) { ?>
                  <div class="col-md-3 mb-3">
                    <a href="<?= base_url('user/keranjang?filter=' . $addon['id_menu']); ?>" class="text-decoration-none">
