...
<body class="g-sidenav-show  bg-gray-200">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-1 fixed-start ms-2   bg-gradient-dark"
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="<?= base_url('customer');?>">
        ...
        <li class="nav-item">
          <a class="nav-link text-white" href="<?= base_url('customer/orders');?>">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <?php foreach ($kategori as $kategori) :
          ?>
        <li class="nav-item">
          <a class="nav-link text-white " href="<?= base_url('customer/kategori?filter=') .$kategori['kategori']?>">
            <div class="text-white text-center me-2  d-flex align-items-center justify-content-center">
              <picture>
