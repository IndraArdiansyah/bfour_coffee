<body>
  ...
  <!-- Main Content -->
  <form class="user" method="post" action="<?= base_url('customer/registrasi'); ?>">
    <div class="container-fluid">
      <div class="row main-content bg-success text-center">
        <div class="col-md-4 text-center company__info">
          <h5 class="logoo">
            <img src="<?php echo base_url('assets/img/avatar1.jpg'); ?>" alt="Image" class="img-fluid "
          ...
          <div class=" container-fluid">
            ...
            <div class="row">
              <div class="form-group first">
                <div class="col">
                  <input type="text" name="nama_admin" id="nama_admin" class="form__input" placeholder="Nama lengkap" required placeholder
