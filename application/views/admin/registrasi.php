          ...
          <div class=" container-fluid">
            ...
            <div class="row">
              <div class="form-group first">
                <div class="col">
                  <input type="text" name="nama_admin" id="nama_admin" class="form__input" placeholder="Nama lengkap"
              ...
              <div class="form-group last">
                <div class="col">
                  <input type="text" name="nip" id="nip" class="form__input" placeholder="Nomor Induk Pegawai"
                    value="<?= set_value('nip'); ?>">
