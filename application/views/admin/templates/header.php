...
<head>
  ...
  <link href="<?= base_url('assets/'); ?>fontawesome-free-6.1.1-web/css/all.min.css" rel="stylesheet" type="text/css">
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/css/registrasi.css');?>" type="text/css">
