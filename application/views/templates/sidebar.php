    ...
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard "
        ...
        <img src="<?php echo base_url('assets/img/upload/logo2.png'); ?>"
          style="max-width: 100%; max-height: 100%; height: 50px; width: 60px; ">
        <span class="ms-1 font-weight-bold text-white">Puskesmas Cipinang</span>
      </a>
    </div>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="../pages/rtl.html">
            ...
            <span class="nav-link-text ms-1">Antrian Poli</span>
          </a>
        </li>
        <li class="nav-item mt-3">
