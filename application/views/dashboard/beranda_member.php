        ...
        <div class="card">
          <div class="card-header pb-0" style="background-color: rgb(47, 79, 79);">
            <div class="row">
              ...
              <div class="col-lg-4 col-4">
                <form action="<?= base_url('member/cari') ?>">
                ...
                <a class="btn btn-warning ms-7" href="<?= base_url('booking'); ?>">
        ...
        <div class="products">
          ...
          ?>
            <div class="product-card">
              ...
              <div class="product">
                <a href="<?= base_url('booking/keranjang?filter=') . $menu['id_menu'] ?>" class="btn btn-sm btn-primary"><i class="fa fa-shopping-cart me-1"></i> Keranjang</a>
                <a href="<?= base_url('member/detailMenu?filter=') . $menu['id_menu'] ?>" class="btn btn-sm btn-outline-secondary"><i class="fa fa-eye me-1"></i> Detail</a>
